...
///        all the objects.
// (-+)
void HurkaMap::dumpEverythingAtPos(IsoPos *searchPos, TrafficManager *tm, std::string ind)
{
...
// (-+)
void HurkaMap::draw(sf::RenderTarget& rt)
{
...
int HurkaMap::placeNewOrSwapRoad(IsoPos *roadPos, int debugLevel)
{
...
// (--)
int HurkaMap::placeNewRoad(IsoPos *roadPos, int debugLevel )
{
    logErr(cn + " placenewroad stub\n");
