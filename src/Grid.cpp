...
/// Grid contains a lot of util functions for doing grid stuff
...
// these pixel positions could have been generated by a tall house block with height=64, while
// the grid is =32 so... we get a faulty gpix_x and gpix_y ... should really re-compute it if we need it here
// alpha-0.2

void Grid::setVisible(CanvasPos *_pos)
{
    ...
    selected_iso_pos.y = _pos->y;
    selected_iso_pos.x = _pos->x;

 /*   selected_pix_pos_delete.y = _pos->y;
    selected_pix_pos_delete.x = _pos->x;*/
}
